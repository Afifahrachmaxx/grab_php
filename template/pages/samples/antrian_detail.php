                            ...
                            <table class="table table-striped">
                              <thead>
                                <tr>
                                  ...
                                  <th>Nomor Antrian</th>
                                  <th>Nama Driver</th>
                                  <th>Keperluan Driver</th>
                                  <th>Timestamp</th>
                                </tr>
                              </thead>
                              <tbody>
                                <?php
                                  $tampil=$koneksi->query("Select * from antriandriver");
                                  $no=1;
                                  while($table = mysqli_fetch_array($tampil)):
                                ?>
                                <tr>
                                  <td><?= $no++; ?></td>
                                  <td><?= $table['nomor_antrian']; ?></td>
                                  <td><?= $table['nama_driver']; ?></td>
                                  <td><?= $table['keperluan_driver']; ?></td>
