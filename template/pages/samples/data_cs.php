                ...
                <div class="card">
                  <div class="card-body">
                    <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="card-title">Data Customer Service</h4>
                          <div class="col my-3">
                            <a
                              class="btn btn-block btn-success btn-lg font-weight-medium auth-form-btn"
                              href="input_profil_cs.php"
                            >
                              Tambah Data Customer Service</a
                            >
                          </div>
                          <div class="table-responsive">
                            <table class="table table-striped">
                              ...
                              <tbody>
                                <?php
                                  $tampil=$koneksi->query("Select * from karyawan");
                                  $no=1;
                                  while($table = mysqli_fetch_array($tampil)):
                                ?>
                                <tr>
                                  <td><?= $no++; ?></td>
                                  <td class="py-1"><?php echo "<img src='img/$table[foto]'/>";?>
                                  </td>
                                  <td><?= $table['nama_cs']; ?></td>
                                  <td><?= $table['nik_cs']; ?></td>
                                  <td><?= $table['jabatan_cs']; ?></td>
                                  <td><?= $table['counter']; ?></td>
                                  <td><?= $table['jeniskelamin_cs']; ?></td>
                                  <td><?= $table['tgllahir_cs']; ?></td>
                                  <td><?= $table['alamat_cs']; ?></td>
                                  <td><?= $table['tlp_cs']; ?></td>
                                  <td><?= $table['email']; ?></td>
                                  ...
                                  <td>
                                    ...
                                    <a href="data_cs.php?hal=hapus&id_cs=<?=$table['id_cs']?>" class="btn btn-danger " onClick="alertFailed('Dihapus','success')">Hapus</a>
                                  </td>
                                </tr>
                                <?php
                                        endwhile;
